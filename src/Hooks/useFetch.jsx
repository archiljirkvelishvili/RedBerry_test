    ...
    useEffect(() =>{
        try{
            (async() => {
                ...
                const listdet = params && await fetch(`https://pcfy.redberryinternship.ge/api/laptop/${params}?token=06bde5318725fe9738dc516b230878fd`)
                ...
                const fetchedlistdet = params && await listdet.json()
